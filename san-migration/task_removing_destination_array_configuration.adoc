...
+
image::../media/remove_destination_array_configuration_from_source_array_1.png[從來源陣列中刪除目標陣列配置]

. 確認刪除主機群組。
+
image::../media/remove_destination_array_configuration_from_source_array_2.png[從來源陣列中刪除目標陣列配置]
